...
public class VisitorDao {
	...
	String encName = AES.encrypt(visitor.getName(), SCERECET_KEY);
	String encEmail = AES.encrypt(visitor.getEmail(),SCERECET_KEY);
	String encPhone = AES.encrypt(visitor.getPhone(), SCERECET_KEY);
	try {
...
public Visitor getVisitorById(int id) {
	...
	try {
		...
		if (resultSet.next()) {
			...
			visitor.setName(AES.decrypt(resultSet.getString(2), SCERECET_KEY));
			visitor.setEmail(AES.decrypt(resultSet.getString(3), SCERECET_KEY));
			visitor.setPhone(AES.decrypt(resultSet.getString(4), SCERECET_KEY));
